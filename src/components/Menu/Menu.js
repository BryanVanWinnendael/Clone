...
function Menu(){
    ...
    return(
        <div className="menudiv">
            ...
            <img src={loginimg} className="imagemenu"  alt="image" />
                {errorReset && <p style={{
                        color:'#A71313'
                }}>{errorReset}</p>}
                {ResetSucces && (
                ...
                {create && (
                    <div>
                        <p className="textlogin"> <b>Create an account </b></p>
                        <Register/>
                        <p onClick={showLogin} style={{
                            fontWeight:"bold",
                            cursor:"pointer",
                            fontSize:"small",
                            color:"#8c56d8",
